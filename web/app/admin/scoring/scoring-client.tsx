  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      <p className="kicker" style={{ marginTop: 6 }}>
        If there’s a tie, resolve it via roll-off, then enter the resulting places for the tied players.
      </p>
      {doc.subEvents
                        ...
                        <tr key={p.personId}>
                          ...
                          <td>
                            <input
                              ...
                              value={r.raw ?? ''}
                              onChange={(e) =>
                                setRaw(g.gameId, p.personId, e.target.value === '' ? null : Number(e.target.value))
                              }
                            />
                          </td>
                          <td>
